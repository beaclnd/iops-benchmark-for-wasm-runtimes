(module
  ...
  (func $get_iops (type 7) (param i64 i64 i64 i64 i64)
  ...
  (func $__wasm_call_dtors (type 9)
    call $dummy.1
    call $__stdio_exit)
  (func $get_iops.command_export (type 7) (param i64 i64 i64 i64 i64)
    local.get 0
    local.get 1
    local.get 2
    local.get 3
